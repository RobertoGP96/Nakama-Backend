...
var UserController = /** @class */ (function () {
    ...
    UserController.getAll = function (_req, res) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, user_1.UserModel.getAll()];
                    case 1:
                        getall = _b.sent();
                        if (getall.length > 0) {
                    ...
                    case 2:
                        _a = _b.sent();
                        return [2 /*return*/, res.status(500).json({ message: "Something is wrong" })];
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        id = req.params.id;
                        return [4 /*yield*/, user_1.UserModel.getByID({ id: id })];
                    case 1:
                        getbyId = _a.sent();
                        //Id check
                        if (!getbyId) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        _a.trys.push([2, 4, , 5]);
                        return [4 /*yield*/, user_1.UserModel.delete({ id: id })];
                    case 3:
                        deleted = _a.sent();
    ...
    UserController.create = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var input, inputV, uniqueInput, uqcheck, createdL, _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        input = req.body;
                        inputV = (0, user_2.validateUser)(req.body);
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, user_1.UserModel.uniqueCheck({ input: uniqueInput })];
                    case 2:
                        uqcheck = _b.sent();
                    ...
                    case 3:
                        _b.trys.push([3, 5, , 6]);
                        return [4 /*yield*/, user_1.UserModel.create({ input: input })];
                    case 4:
                        createdL = _b.sent();
    ...
    UserController.update = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var id, input, inputV, idCheck, uniqueInput, uqcheck, updatedL, _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        id = req.params.id;
                    ...
                    case 4:
                        _b.trys.push([4, 8, , 10]);
                        return [4 /*yield*/, user_1.UserModel.update({
                                id: id,
                                input: input,
                            })];
                    case 5:
                    ...
                    case 11: return [4 /*yield*/, res.status(409).json({ message: "Email, Nick and Phone must be unique" })];
